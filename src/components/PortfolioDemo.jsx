...
import resumePDF from '../assets/Yash-Surendra-Katmore-Resume.pdf'
        ...
        return (
          <div className="text-center flex flex-col items-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <a href={resumePDF} download className="bg-white border border-blue-600 text-blue-600 px-6 py-3 rounded-lg hover:bg-blue-600 hover:text-white transition-colors font-semibold">
                Download Resume
              </a>
            </div>
          </div>
        ...
        return (
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              ...
              <a href={resumePDF} download className="inline-block mt-6 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors font-semibold">
                Download Resume
              </a>
            </div>
          </div>
